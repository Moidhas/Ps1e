...
u32 read(Cpu &cpu, u32 address) { return cpu.mmap->load32(VAddress{address}); }
...
void assemble_blob(vector<u32> blob) {
    for (u32 opcode : blob) {
        DebugInfo assem = Opcode::decode(opcode);
        println("{}", assem);
    }
}
...
void test_beq() {
    ...
    write_blob(cpu, 0x80100000,
               vector<u32>{0x10220005, 0x00000000, 0x200a0001, 0x10640004,
                           0x00000000, 0x200b0001, 0x200a0002, 0x00000000,
                           0x00000000, 0x0bab6fb8, 0x00000000});
...
void test_branch_in_branch_delay() {
    ...
    write_blob(cpu, 0x80100000,
               vector<u32>{0x10000002, 0x10000004, 0x20030001, 0x20010001,
                           0x10000002, 0x00000000, 0x20020001, 0x00000000,
...
void test_lwr_and_lwr_load_delay() {
    ...
    write_blob(
        cpu, 0x80100000,
        vector<u32>{0x2401ffff, 0x98010002, 0x88010005, 0x00201021, 0x2403ffff,
...
void test_add_1() {
    ...
    write_blob(cpu, 0x80100000,
               vector<u32>{0x00201820, 0x00222020, 0x00412820, 0x00423020,
                           0x0bab6fb8, 0x00000000});
...
void test_arithmetic_branching_test() {
    ...
    write_blob(cpu, 0x80100000,
               vector<u32>{0x00451023, 0x24630001, 0x1c40fffd, 0x00000000,
                           0x0bab6fb8, 0x00000000});
...
void test_unaligned_loads() {
    ...
    write_blob(cpu, 0x80100000,
               vector<u32>{0x83c10000, 0x93c20000, 0x0bab6fb8, 0x00000000});
...
void test_load_delay_for_cop() {
    ...
    write_blob(cpu, 0x80100000,
               vector<u32>{0x8c430000, 0x00000000, 0x4803c800, 0x10600004,
                           0x00000000, 0x20010001, 0x0804000a, 0x00000000,
                           0x20010002, 0x0804000a, 0x0bab6fb8, 0x00000000});
...
void test_load_cancel() {
    ...
    write_blob(cpu, 0x80100000,
               vector<u32>{0x40016000, 0x8c010000, 0x40017800, 0x8c010000,
                           0x8c010000, 0x00201021, 0x0bab6fb8, 0x00000000});

    // assemble_blob(vector<u32>{0x40016000, 0x8c010000, 0x40017800, 0x8c010000,
    //                           0x8c010000, 0x00201021, 0x0bab6fb8, 0x00000000});
...
void test_lwl_and_lwr() {
    ...
    write_blob(
        cpu, 0x80100000,
        vector<u32>{0x98010000, 0x88010003, 0x98020001, 0x88020004, 0x98030002,
...
void test_lh_and_lb_sign_extension() {
    ...
    write_blob(cpu, 0x80100000,
               vector<u32>{0x84010000, 0x94020000, 0x80030000, 0x90040000,
                           0x00000000, 0x0bab6fb8, 0x00000000});
...
void test_add_ovf() {
    Cpu cpu;
    cpu.add(0x7FFFFFFF, 1);
    cpu.add(0x80000000, -1);
}
